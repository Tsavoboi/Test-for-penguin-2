...
#First for this homework I installed and loaded the packages required, the installation was done in the console for cleaner code. 
library(tidyverse)
...
write.csv (penguins_clean, here("data","penguins_raw.csv"))
...
png(filename="C:/Homework For Penguin data/Figures/Flipper_and_body_mass.png")
plot(Fig.1)
dev.off()
...
Table.1
png(filename="C:/Homework For Penguin data/Figures/ANOVA_for_Flipper_and_body_mass.png")
plot(Table.1)
dev.off()
